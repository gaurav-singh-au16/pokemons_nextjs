            ...
            <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                ...
                <div className="flex items-center">
                    {pokemonData.length != 0 && pokemonData.weaknesses.map((weakness: string) => (
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 bg-rose-700/[.06] ...">{weakness}</span>
                ...
                <div className="flex items-center">
                    {pokemonData.length != 0 && pokemonData.resistant.map((resistance: string) => (
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 bg-rose-700/[.06] ...">{resistance}</span>
