    ...
    <div className="container mx-auto">
      <div className='flex flex-wrap gap-4 justify-center items-center'>
        {PokemonData && PokemonData.map((pokemon: any) => (
          <div className="max-w-sm rounded overflow-hidden shadow-lg cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110" onClick={() => detailPageNavigation(pokemon.name)}>
